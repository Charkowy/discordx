...
import { ActionTooltip } from "@/components/ui/action-tootips";
            ...
            {role !== MemberRole.GUEST && sectionType == "channels" && (
                <ActionTooltip label="Create Channel" side="top">
                    <button
                        ...
                        className="text-zinc-500 hover:text-zinc-600 darl:text-zinc-400 dark:hover:text-zinc-300 transition">
